...
export const Button = React.forwardRef<HTMLButtonElement, Props>(function Button({ className="", variant="solid", ...props }, ref){
  ...
  const styles=variant==="outline"?"border border-white/10 text-white hover:bg-white/5":"bg-gradient-to-r from-cyan-400 to-emerald-400 text-black font-bold shadow hover:from-cyan-300 hover:to-emerald-300";
